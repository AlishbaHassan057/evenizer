        ...
        <div className="row gap-4">
          ...
          <div className="col-lg-5 mt-4">
            ...
            <div className="row ">
              {/* again-left-side */}
              <div
                className="box col-lg-5 rounded-2 py-1 px-0"
                data-aos="fade-up"
              ...
              >
                <div className="box d-flex flex-column align-items-center  justify-content-center text-center mx-auto gap-2 ">
                  ...
                  <div className="ten fw-bolder">
                    <h1>
                      10{" "}
                      <span>
                        <FaPlus size={12} color="DA22FF" />
                      </span>
                    </h1>
                  </div>
                  <div className="exp mb-4 mt-0">
            ...
            <div
              className="btn fs-6 fw-bold py-2 mt-4 fs-6"
              data-aos="fade-up"
